...
class EmployeeController extends Controller {
    ...
    */
    ...
    public function index() {
        $list = Employee::orderBy( 'created_at', 'DESC' )->paginate( 5 );
    ...
    */
    ...
    public function edit( $id ) {
        $emplooyee = Employee::find( $id );
        return json_encode( [ 'data'=>$emplooyee ] );
    }
    ...
    */
    ...
    public function update( Request $request, $id ) {
        ...
        if ( $update ) {
            return json_encode( [ 'status'=>200, 'messages'=>'Record Update Successfully', 'result'=>'pass' ] );
